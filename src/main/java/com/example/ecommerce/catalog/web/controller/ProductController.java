...
public class ProductController {
    ...
    public ResponseEntity<PageResponseDto<PaginatedProductListResponseDto>> getPaginatedProducts(
        ...
        PageResponseDto<PaginatedProductListResponseDto> products =
                productService.getPaginatedProducts(page, size);
    ...
    public ResponseEntity<PageResponseDto<SearchProductResponseDto>> search(
            ...
            @Parameter(
                            name = "sort",
                            description = "Sort format: `field`. Examples: `price`, `createdAt`",
                            example = "price",
                            required = true)
        ...
        return ResponseEntity.ok(
                productService.searchProducts(searchQuery, inStock, page, limit, sort));
    }
