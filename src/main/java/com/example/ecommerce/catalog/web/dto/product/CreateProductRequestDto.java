...
public record CreateProductRequestDto(@NotBlank String productName, String description, @NotNull UUID brandId,
                                      ...
                                      @DecimalMin(value = "0.00", inclusive = false) @Digits(integer = 10, fraction =
                                              2) BigDecimal price,
                                      String size, String color, String sku, @NotNull Product.Status status) {
}
